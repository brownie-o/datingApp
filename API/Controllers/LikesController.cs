...
public class LikesController(IUnitOfWork uow) : BaseApiController
{
  ...
  public async Task<ActionResult> ToggleLike(string targetMemberId)
  {
    ...
    if (existingLike == null)
    {
      ...
      uow.LikesRepository.AddLike(like); // add to entity framework change tracker
    }
    else
    {
  ...
  [HttpGet]
  // return the list of Members who the user has liked, been liked by, or mutual as well
  // predicate: type of list they like to receive
