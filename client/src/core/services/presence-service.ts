...
export class PresenceService {
  ...
  createHubConnection(user: User) {
    this.hubConnection = new HubConnectionBuilder().withUrl(this.hubUrl + 'presence', {
      // accessTokenFactory: pass the token as a query string parameter, negotiate with the API server about what connection protical it supports for real-time communication,
